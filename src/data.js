...
window.PORTFOLIO_DATA = {
  name: "Syed Yousha",
  handle: "Syed-Yousha",
  tagline: "Software Engineer focused on Machine Learning and Data Science. I build scalable, AI-driven applications from the model all the way to production.",
